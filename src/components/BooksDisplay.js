...
class BooksDisplay extends Component  {
  ...
  let link = (this.props.goodreads === '404'
    ...
    :
    <div>
    <h2>Link:  </h2> <h3> <a href= { this.props.goodreads} target="blank" className='link'>To Goodreads</a></h3>
    </div>)
  ...
  return (
    <div className="bookstodisplayDiv">
      ...
      <div className="textnextToImg">
        <h2>Title: </h2>
        <h3> {this.props.title.length > 30 ?  this.props.title.substring(0, 30) + '...': this.props.title}</h3>
        <br></br>
        <h2>Author: </h2>
        <h3> { this.props.author_name[0]}</h3>
        <br></br>
        {link}
